...
```{r}
# Save trial river 
#saveRDS(trial_river, here::here("data", "cleaned", "trial_river.rds"))

# Save current and future dams cleaned
#saveRDS(current_dams, here::here("data", "cleaned", "current_dams_cleaned.rds"))
#saveRDS(future_dams, here::here("data", "cleaned", "future_dams_cleaned.rds"))

# Save Nepal masked 
#saveRDS(nepal_basin, here::here("data", "cleaned", "nepal_basin.rds"))
#saveRDS(nepal_current_dams, here::here("data", "cleaned", "nepal_current_dams.rds"))
#saveRDS(nepal_future_dams, here::here("data", "cleaned", "nepal_future_dams.rds"))
#saveRDS(nepal_rivers, here::here("data", "cleaned", "nepal_rivers.rds"))
